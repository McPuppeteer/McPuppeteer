...
public final class RotationUtils {
    ...
    public static final Vec3d[] BLOCK_SIDE_MULTIPLIERS = new Vec3d[]{new Vec3d(0.5, 0.0, 0.5), new Vec3d(0.5, 1.0, 0.5), new Vec3d(0.5, 0.5, 0.0), new Vec3d(0.5, 0.5, 1.0), new Vec3d(0.0, 0.5, 0.5), new Vec3d(1.0, 0.5, 0.5)};
