...
public class MinihudUtils {
	...
	/* Adapted from
	 * https://github.com/sakura-ryoko/minihud/blob/1.21.5/src/main/java/fi/dy/masa/minihud/event/RenderHandler.java#L98
	 */
	public static int getMinhudHeight() {
		...
		try {
			...
			/* Evil casting */
			@SuppressWarnings("unchecked cast") List<Object> lines = (List<Object>) f.get(handler);

			/* Stolen math */
			return (int) (lines.size() * (StringUtils.getFontHeight() + 2) *
				      Configs.Generic.FONT_SCALE.getDoubleValue());
