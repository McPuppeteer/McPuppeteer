...
@PuppeteerCommand(
    cmd = "join world",
    description =
        "Joins a local world. This requires one parameter, 'load name', which needs to be the EXACT"
            + " same as from 'load name' from 'get worlds'")
                      ...
                      () -> {
                        callback.resultCallback(
                            BaseCommand.jsonOf(
                                ...
                                "message",
                                    "Unknown world join error, are you sure you sent the 'load"
                                        + " name' parameter directly from the 'load name' value"
                                        + " from 'get worlds'?"));
