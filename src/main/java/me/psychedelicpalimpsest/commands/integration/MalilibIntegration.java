...
public class MalilibIntegration {
  ...
  */
  ...
  @PuppeteerCommand(
      cmd = "get malilib config item",
      description = "Gets specific malilib config item")
  ...
  @PuppeteerCommand(
      cmd = "set malilib config item",
      description = "Sets specific malilib config item")
