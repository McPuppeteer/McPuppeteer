...
public class TweakerooIntegration {
  ...
  */
  ...
  @PuppeteerCommand(
      cmd = "dump tweakeroo config",
      description = "Dumps tweakeroos config",
  ...
  @PuppeteerCommand(
      cmd = "get tweakeroo config item",
      description = "Gets specific tweakeroo config item",
      mod_requirements = "tweakeroo")
  ...
  @PuppeteerCommand(
      cmd = "set tweakeroo config item",
      description = "Sets specific tweakeroo config item",
      mod_requirements = "tweakeroo")
  ...
  @PuppeteerCommand(
      cmd = "exec tweakeroo config item",
