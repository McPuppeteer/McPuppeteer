...
public class LitematicaIntegration {
  ...
  @PuppeteerCommand(
      cmd = "dump litematica config",
      description = "Dumps litematicas config",
  ...
  @PuppeteerCommand(
      cmd = "get litematica config item",
      description = "Gets specific litematica config item",
      mod_requirements = "litematica")
  ...
  @PuppeteerCommand(
      cmd = "set litematica config item",
      description = "Sets specific litematica config item",
      mod_requirements = "litematica")
  ...
  @PuppeteerCommand(
      cmd = "exec litematica config item",
