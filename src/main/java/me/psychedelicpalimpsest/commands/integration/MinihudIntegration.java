...
public class MinihudIntegration {
  ...
  @PuppeteerCommand(
      cmd = "dump minihud config",
      description = "Dumps minihuds config",
  ...
  @PuppeteerCommand(
      cmd = "get minihud config item",
      description = "Gets specific minihud config item",
      mod_requirements = "minihud")
  ...
  @PuppeteerCommand(
      cmd = "set minihud config item",
      description = "Sets specific minihud config item",
      mod_requirements = "minihud")
  ...
  @PuppeteerCommand(
      cmd = "exec minihud config item",
      description = "Executes specific minihud hotkey config item",
      mod_requirements = "minihud")
