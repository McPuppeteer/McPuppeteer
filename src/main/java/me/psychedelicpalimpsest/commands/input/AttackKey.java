...
@PuppeteerCommand(cmd = "attack key click", description = "Simulate a single click of the attack key",
...
public class AttackKey implements BaseCommand {
	...
	public void onRequest(JsonObject request, LaterCallback callback) {
		MinecraftClient.getInstance().execute(() -> {
			/* Wtf does this do? I just reset attackCooldown because of the check, but what does it actually
			 * do??????*/
