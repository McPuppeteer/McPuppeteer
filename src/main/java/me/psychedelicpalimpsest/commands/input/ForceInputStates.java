...
@PuppeteerCommand(
    cmd = "force inputs",
    description =
        "Takes an 'inputs' parameter identical to 'get forced input's parameter. Also takes an"
            + " array of strings 'remove' which will remove forced values",
          ...
          .forEach(
              (obj) -> {
                ...
                MinecraftClient.getInstance()
                    .execute(() -> PuppeteerInput.isForcePressed.remove(remove));
              });
    }
