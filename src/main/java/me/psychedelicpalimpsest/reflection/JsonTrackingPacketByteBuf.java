...
public class JsonTrackingPacketByteBuf extends RegistryByteBuf {
  ...
  public static DynamicRegistryManager getSomethingAsARegistry() {
    ...
    else return DynamicRegistryManager.of(Registries.REGISTRIES);
  }
  ...
  public PacketByteBuf writeNbt(@Nullable NbtElement nbt) {
    ...
    appendToJson(
        wrapWithType("NBT", new JsonPrimitive(Base64.encodeBase64String(byteBuf.array()))));
  ...
  public <T> void writeCollection(
      Collection<T> collection, PacketEncoder<? super PacketByteBuf, T> writer) {
    JsonArray jsonArray = new JsonArray();
  ...
  public static JsonObject jsonOfEnum(Enum<?> instance) {
    ...
    jsonObject.addProperty(
        ...
        YarnMapping.getInstance()
            .mapClassName(YarnMapping.Namespace.NAMED, instance.getClass().getName()));
  ...
  public PacketByteBuf writePublicKey(PublicKey publicKey) {
    appendToJson(
        wrapWithType(
            "PublicKey", new JsonPrimitive(Base64.encodeBase64String(publicKey.getEncoded()))));
